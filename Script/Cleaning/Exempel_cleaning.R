...
drop <- c("Study.ID", "Sample.ID", "Number.of.Samples.Per.Patient", "Sample.Type", "Somatic.Status", "therapy")
...
View(data_female)
View(data_male)
<<<<<<< Updated upstream:Script/Cleaning/Exempel_cleaning.R
=======

data_male_no_NA <- na.omit(data_male)
data_female_no_NA <- na.omit(data_female)

View(data_male_no_NA)
View(data_female_no_NA)

>>>>>>> Stashed changes:Script/Dataanalys_exempel.R
